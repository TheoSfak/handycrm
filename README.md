...
- 🔔 **Update notifications** — ο έλεγχος νέας έκδοσης συγκρίνει πλέον installed vs latest version.
- 📦 **Υλικά** — τυποποίηση μονάδων μέτρησης με προκαθορισμένες επιλογές και migration για υπάρχουσες εγγραφές.
- 🕒 **Εργασίες Ημέρας** — οι συνολικές ώρες ενημερώνονται από τις ώρες τεχνικών.
- 📊 **Αναφορές** — τα έσοδα Συντηρήσεων Υ/Σ προστίθενται στα συνολικά και μηνιαία έσοδα.
- 🌍 **Μεταφράσεις** — συμπλήρωση κενών i18n keys και καθαρό ελληνικό label για αλλαγή κατάστασης τιμολογίου.
...
### v1.7.58 — 2026-05-11
- 🔔 Διόρθωση ειδοποίησης νέας έκδοσης ώστε να εμφανίζεται μόνο όταν `installed_version < latest_version`
- 📦 Τυποποίηση μονάδων υλικών με canonical dropdown και migration υπαρχόντων εγγραφών
- 🕒 Σύνοψη ωρών Εργασιών Ημέρας από `SUM(technician_hours)`
- 📊 Συμπερίληψη εσόδων Συντηρήσεων Υ/Σ στις Αναφορές
- 🌍 Συμπλήρωση κενών ελληνικών μεταφράσεων και i18n για `conversion_rate`

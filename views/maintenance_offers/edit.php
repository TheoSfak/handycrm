<?php $pageTitle = 'Επεξεργασία Προσφοράς Συντήρησης'; ?>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <h5 class="mb-0">Επεξεργασία Προσφοράς: <span class="text-muted"><?= htmlspecialchars($offer['offer_number']) ?></span></h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>/maintenance-offers/update/<?= $offer['id'] ?>">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" name="transformers_count"
                                       ...
                                       value="<?= (int)$offer['transformers_count'] ?>"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="custom_price"
                                           id="customPrice"
                                           value="<?= htmlspecialchars($offer['price'] ?? '') ?>"
                                           min="0" step="0.01"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="offer_expiry_date"
                                       value="<?= htmlspecialchars($offer['offer_expiry_date'] ?? '') ?>">
                            </div>
                        </div>
                        ...
                        <div class="alert alert-light border mb-4" id="pricePreview">
                            ...
                            Υπολογιζόμενη τιμή: <strong id="calcPrice"></strong>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="notes" rows="3"
                                      placeholder="Τυχόν ειδικοί όροι ή παρατηρήσεις..."><?= htmlspecialchars($offer['notes'] ?? '') ?></textarea>
                        </div>

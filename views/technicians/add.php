...
$pageTitle = $title ?? 'Προσθήκη Τεχνικού';
...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Νέος Τεχνικός</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>/technicians/add" id="technicianForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               id="role_technician" 
                                               value="technician"
                                               <?= (!isset($data['role']) || $data['role'] === 'technician') ? 'checked' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               id="role_assistant" 
                                               value="assistant"
                                               <?= (isset($data['role']) && $data['role'] === 'assistant') ? 'checked' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" 
                                       ...
                                       step="0.01" 
                                       min="0"
                                       value="<?= htmlspecialchars($data['hourly_rate'] ?? '') ?>"
                                       required>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?= BASE_URL ?>/technicians" class="btn btn-secondary">

        ...
        <ul class="nav flex-column mt-1">
            ...
            <li class="nav-item">
                <a class="nav-link <?= strpos($currentRoute, '/knowledge-base') !== false ? 'active' : '' ?>" href="<?= BASE_URL ?>/knowledge-base">
                    <i class="fas fa-book-open"></i> <?= __('menu.knowledge_base', 'Βάση Γνώσης') ?>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
                <a class="nav-link <?= strpos($currentRoute, '/price-lists') !== false ? 'active' : '' ?>" href="<?= BASE_URL ?>/price-lists">
                    <i class="fas fa-tags"></i> <?= __('menu.price_lists', 'Τιμοκατάλογοι') ?>
                </a>
            </li>
            <?php endif; ?>
            <?php endif; ?>
        ...
        <nav class="navbar">
            <div class="d-flex align-items-center gap-2">
                ...
                <p class="page-title mb-0">
                    ...
                    elseif (strpos($uri, '/knowledge-base') !== false) echo __('menu.knowledge_base', 'Βάση Γνώσης');
                    elseif (strpos($uri, '/price-lists') !== false) echo __('menu.price_lists', 'Τιμοκατάλογοι');

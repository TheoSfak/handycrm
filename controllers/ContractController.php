...
class ContractController extends BaseController {
    ...
    private function buildDocx(array $p, array $tasks, float $mat, float $lab, float $subtotal, float $vat, float $grandTotal, string $custName, string $techName, array $settings = [], float $vatRate = 24): PhpWord {
        ...
        $section->addText(
            'Όλα τα κατ\'αποκοπήν τμήματα του παρόντος τιμολογίου, αναφέρουν την αξία, τόσο των απαιτουμένων αρίστης ποιότητος υλικών, όσο και της απαιτούμενης εργασίας εργοτεχνιτών, όπως όλα αυτά καθορίζονται στο παρόν τιμολόγιο, για την πλήρη και άρτια εκτέλεση και την άψογη εμφάνιση του όλου έργου.',
            null, $justify + $pN
        );
        $section->addText(
            'Τα κατ\'αποκοπή τιμήματα του παρόντος τιμολογίου, αναφέρονται σε έργα (σύνολα εργασιών), πλήρως και άρτια περαιωμένα και περιλαμβάνουν όλες τις δαπάνες για την πλήρη εκτέλεση του συνόλου των εργασιών του όλου έργου, σύμφωνα με τους όρους του παρόντος τιμολογίου και την μελέτη εφαρμογής που παραδόθηκε από τον Εργοδότη στον Ανάδοχο. Σε κάθε περίπτωση στα κατ\'αποκοπή τμήματα, ενδεικτικά και όχι περιοριστικά περιέχεται:',
            null, $justify + $pN
        );
        foreach ([
            '«Κάθε δαπάνη» γενικά, έστω και αν δεν κατονομάζεται ρητά αλλά είναι απαραίτητη για την πλήρη και έντεχνη εκτέλεση της μονάδας κάθε εργασίας. Καμία αξίωση η διαμφισβήτηση δεν μπορεί να θεμελιωθεί που να έχει σχέση με το είδος και την απόδοση των μηχανημάτων, την ειδικότητα και τον αριθμό του εργατοτεχνικού προσωπικού, όπως και την δυνατότητα χρησιμοποίησης ή όχι μηχανικών μέσων.',
            'Η αξία, επί τόπου των έργων και ετοίμων για χρήση, όλων των απαιτουμένων αρίστης ποιότητας υλικών, ενσωματωμένων ή όχι, κυρίων και βοηθητικών, οπωσδήποτε απαιτουμένων και απαραίτητων για την πλήρη εκτέλεση και έντεχνη εμφάνιση των εργασιών, σύμφωνα με τους κανόνες της τέχνης και τους όρους των στοιχείων του έργου, έστω και μη ρητώς καθοριζομένων στο τιμολόγιο, τα σχέδια και τα λοιπά συμβατικά τεύχη.',
            'Η δαπάνη για την φθορά και απομείωση των υλικών γενικά.',
            'Η δαπάνη προσκόμισης και προσέγγισης όλων των υλικών μέχρι τα σημεία χρησιμοποίησής τους.',
            'Κάθε είδους επιβάρυνση των ενσωματωμένων υλικών από φόρους, τέλη, δασμούς, έξοδα εκτελωνισμού, ειδικούς φόρους κ.λπ., πλην του Φ.Π.Α.',
            'Οι δαπάνες μισθών, ημερομισθίων, υπερωριών, υπερεργασιών, ασφαλιστικών εισφορών (στο Ι.Κ.Α., σε ασφαλιστικές εταιρείες, ή σε άλλους ημεδαπούς ή/και αλλοδαπούς ασφαλιστικούς οργανισμούς κλπ.), δώρων εορτών, επιδομάτων που καθορίζονται από τις ισχύουσες εκάστοτε Συλλογικές Συμβάσεις Εργασίας (αδείας, οικογενειακού, θέσεως, ανθυγιεινής εργασίας, εξαιρέσιμων αργιών κ.λπ.).',
            'Η δαπάνη για την μόρφωση ή διάνοιξη αυλάκων ή οπών ή φωλεών, διόδου ή εντοιχισμού σωληνώσεων ή αγωγών ή εξαρτημάτων των παντός είδους εγκαταστάσεων κ.λπ. σε τοίχους, οροφές ή πατώματα από οποιοδήποτε υλικό και οποιουδήποτε πάχους, σύμφωνα με την μελέτη των ηλεκτρομηχανολογικών εγκαταστάσεων.',
            'Οι δαπάνες διάνοιξης τομών ή οπών στα τοιχώματα υφισταμένων αγωγών, φρεατίων, τεχνικών έργων κ.λπ., με οποιαδήποτε μέσα, για τη σύνδεση νέων συμβαλλόντων αγωγών, εκτός αν προβλέπεται ιδιαίτερη πληρωμή προς τούτο στα τεύχη δημοπράτησης.',
            'Δαπάνη για έξοδα του αναδόχου και του παντός είδους προσωπικού για αποζημιώσεις, έξοδα κινήσεως.',
            'Οι δαπάνες για έξοδα αποθήκευσης και διαφύλαξης των πάσης προέλευσης και είδους υλικών, έξοδα παντός είδους καταμετρήσεων, επιμετρήσεων, πιστοποιήσεων, εντολών πληρωμής.',
        ] as $term) {
        ...
        foreach ([
            'Ο εργοδότης μπορεί να κηρύξει τον εργολάβο έκπτωτο στην περίπτωση που ο εργολάβος θα επιδείξει προφανή αδυναμία στην έντεχνη εκτέλεση των εργασιών ή κακοπιστία έναντι του εργοδότη ή αδιαφορία για την τήρηση των όρων του παρόντος συμφωνητικού και των νόμων. Επίσης, στην περίπτωση που ο εργολάβος θα καθυστερήσει την έναρξη ή θα διακόψει αναιτιολόγητα την εκτέλεση των εργασιών επί 10ήμερο, και στην περίπτωση που θα κηρυχθεί σε κατάσταση πτωχεύσεως. Η έκπτωση συντελείται με την επίδοση σχετικής Εξωδίκου Δηλώσεως του εργοδότη προς τον εργολάβο. Από της κοινοποιήσεως της εκπτώσεως, η κατοχή και χρήση ολόκληρου του χώρου του έργου περιέρχεται στον εργοδότη, κάθε δε ανάμειξη του εργολάβου στο εργοτάξιο αποτελεί διατάραξη της κατοχής του εργοδότη.',
            'Η εργασία θα είναι έντεχνη και θα εκτελείται από προσωπικό απολύτως εξειδικευμένο. Ο επιβλέπων μηχανικός θα διατάξει την αποξήλωση κάθε κακότεχνης κατασκευής ή θα κάνει περικοπή τιμής εφόσον το μέγεθος ή το είδος ή η φύση της κακοτεχνίας επιτρέπει ή επιβάλλει την κατ\' ανοχήν αποδοχή της, κατά την κρίση του. Η δαπάνη καθαιρέσεως και επανακατασκευής βαρύνει τον εργολάβο.',
            'Ο εργολάβος είναι αποκλειστικά υπεύθυνος για την τήρηση όλων των μέτρων και διατάξεων ασφαλείας, από ολόκληρο το εργατοτεχνικό προσωπικό που θα χρησιμοποιηθεί στο έργο. Ο εργολάβος δηλώνει ότι έχει γνώση των κειμένων διατάξεων για την υγεία και ασφάλεια των εργαζομένων και ότι έπίσης έχει λάβει γνώση των υποδείξεων για μέτρα ασφαλείας εργαζομένων, τις συνολικές οικονομικές επιβαρύνσεις των οποίων έχει λάβει υπ\' όψη κατά τη σύνταξη της προσφοράς του. Ολόκληρο το προσωπικό που θα χρησιμοποιηθεί θα είναι ασφαλισμένο κατά τον Νόμο. Ο εργοδότης δεν φέρει καμία ευθύνη έναντι τρίτων για ζημιές που οφείλονται στην εκτέλεση των εργασιών από τον εργολάβο, όπως και για κάθε τυχόν θανατηφόρο ατύχημα στο προσωπικό του εργολάβου ή σε κάθε τρίτο κατά την εκτέλεση του έργου.',
            'Οι παραπάνω συμφωνημένες τιμές μονάδος και κατ\' επέκταση το κατ\'αποκοπή τίμημα, δεν υπόκεινται σε αναθεώρηση παρά μόνο με έγγραφη συμφωνία. Ο εργολάβος δηλώνει ότι κατά τη σύνταξη της προσφοράς του έλαβε υπ\' όψη του όλα τα στοιχεία κόστους που μπορούν να επηρεάσουν την αμοιβή του και εγγυάται την ακρίβειά τους, παραιτούμενος από κάθε δικαίωμά του που πηγάζει από το άρθρο 696 του Αστικού Κώδικα. Και τα δύο συμβαλλόμενα μέρη συμφωνούν ότι παραιτούνται των δικαιωμάτων που τους παρέχει το άρθρο 388 του Α.Κ. για μεταβολή των συνθηκών με βάση τις οποίες καταρτίσθηκε η παρούσα συμφωνία. Σε περίπτωση διαφωνίας, αυτή επιλύεται από τα Δικαστήρια Ηρακλείου.',
        ] as $i => $term) {

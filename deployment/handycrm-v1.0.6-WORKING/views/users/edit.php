                ...
                <form method="POST" action="?route=/users/edit&id=<?= $editUser['id'] ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="role" name="role" required>
                            <option value="technician" <?= $editUser['role'] === 'technician' ? 'selected' : '' ?>><?= __('users.technician') ?></option>
                            <option value="admin" <?= $editUser['role'] === 'admin' ? 'selected' : '' ?>><?= __('users.admin') ?></option>
                        </select>
                    </div>

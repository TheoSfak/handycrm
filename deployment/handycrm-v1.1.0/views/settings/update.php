...
// Automated updates enabled - GitHub releases are configured
$automatedUpdatesEnabled = true;
...
if (isset($_POST['restore_version']) && isset($_POST['restore_version_number']) && $automatedUpdatesEnabled) {
...
} elseif (isset($_POST['restore_version']) && !$automatedUpdatesEnabled) {
    $actionMessage = 'Οι αυτόματες ενημερώσεις είναι απενεργοποιημένες. Παρακαλώ ενημερώστε χειροκίνητα.';
    $actionType = 'warning';
}

// Automated update to newer version
if (isset($_POST['install_update']) && isset($_POST['update_url']) && isset($_POST['update_version']) && $automatedUpdatesEnabled) {
    set_time_limit(300); // Allow 5 minutes for download and installation
...
} elseif (isset($_POST['install_update']) && !$automatedUpdatesEnabled) {
    $actionMessage = 'Οι αυτόματες ενημερώσεις είναι απενεργοποιημένες. Παρακαλώ ενημερώστε χειροκίνητα.';
    $actionType = 'warning';
}
...
// Get version history only if automated updates enabled
$versionHistory = $automatedUpdatesEnabled ? $updateChecker->getAllVersions() : [];

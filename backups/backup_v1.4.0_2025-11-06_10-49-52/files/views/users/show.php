            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        <span class="badge bg-<?= $viewUser['role'] === 'admin' ? 'danger' : ($viewUser['role'] === 'technician' ? 'primary' : ($viewUser['role'] === 'maintenance_technician' ? 'warning' : 'info')) ?>">
                            <?php 
                            $roleLabels = [
                                'admin' => 'Διαχειριστής',
                                'supervisor' => 'Υπεύθυνος Συνεργείου', 
                                'technician' => 'Τεχνικός',
                                'assistant' => 'Βοηθός Τεχνικού',
                                'maintenance_technician' => 'Τεχνικός Συντηρήσεων Υ/Σ'
                            ];
                            echo $roleLabels[$viewUser['role']] ?? ucfirst($viewUser['role']);
                            ?>
                        </span>

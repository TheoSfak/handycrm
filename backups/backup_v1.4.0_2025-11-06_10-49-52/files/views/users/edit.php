                ...
                <form method="POST" action="?route=/users/edit&id=<?= $editUser['id'] ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="role" name="role" required>
                            ...
                            <option value="supervisor" <?= $editUser['role'] === 'supervisor' ? 'selected' : '' ?>>Υπεύθυνος Συνεργείου</option>
                            ...
                            <option value="maintenance_technician" <?= $editUser['role'] === 'maintenance_technician' ? 'selected' : '' ?>>Τεχνικός Συντηρήσεων Υ/Σ</option>
                        </select>
                    </div>
